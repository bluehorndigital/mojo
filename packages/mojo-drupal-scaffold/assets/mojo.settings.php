...
if (!empty($_ENV['FILESYSTEM_DRIVER']) && $_ENV['FILESYSTEM_DRIVER'] !== 'local') {
  include $app_root . '/' . $site_path . '/settings.filesystems.php';
}

// If a Redis host is defined, Drupal isn't installing, and the Redis extension
// is available, include config.
